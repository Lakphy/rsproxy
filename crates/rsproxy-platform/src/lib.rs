...
//! local control-socket naming, and desktop system-proxy configuration. Planning APIs expose the
//! commands and state changes before execution so callers can implement dry runs and reviewable
//! output.
//!
