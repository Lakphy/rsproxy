...
pub(crate) use har::sessions_har;
...
pub(crate) fn string(input: &str) -> String {
    format!("\"{}\"", escape(input))
}

pub(crate) fn session_summary(session: &Session) -> String {
    format!(
...
pub(crate) fn session_detail(session: &Session) -> String {
    format!(
...
pub(crate) fn sessions_table(sessions: &[Session]) -> String {
...
pub(crate) fn stats(stats: TraceStats) -> String {
    format!(
...
pub(crate) fn headers(headers: &[(String, String)]) -> String {
    format!(
        "[{}]",
        headers
            .iter()
...
pub(crate) fn opt_string(value: Option<&str>) -> String {
