...
pub(super) struct H2RequestReader {
    receiver: mpsc::Receiver<io::Result<DownstreamH2RequestFrame>>,
    runtime: Handle,
    pending: Vec<u8>,
    offset: usize,
...
impl H2RequestReader {
    ...
    fn refill(&mut self) -> io::Result<()> {
        ...
        loop {
            ...
            match frame {
                Some(DownstreamH2RequestFrame::Data(data)) if data.is_empty() => continue,
                Some(DownstreamH2RequestFrame::Data(data)) => {
                ...
                Some(DownstreamH2RequestFrame::Trailers(trailers)) => {
                    self.pending = b"0\r\n".to_vec();
    ...
    fn receive(&mut self) -> io::Result<Option<DownstreamH2RequestFrame>> {
