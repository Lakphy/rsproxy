...
pub(crate) fn write_response<W: Write + ?Sized>(
    stream: &mut W,
    status: u16,
    reason: &str,
...
pub(crate) fn write_response_with_version_and_connection<W: Write + ?Sized>(
    stream: &mut W,
    version: &str,
    status: u16,
    reason: &str,
...
pub(crate) fn write_response_head<W: Write + ?Sized>(
    stream: &mut W,
...
pub(crate) fn write_response_head_with_connection<W: Write + ?Sized>(
    stream: &mut W,
    head: &RawResponseHead,
    headers: &[(String, String)],
    keep_alive: bool,
